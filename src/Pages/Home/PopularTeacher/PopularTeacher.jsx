...
const PopularTeacher = () => {
    ...
    return (
        <div>
            <h2 className='uppercase text-[#e50e84] text-center text-4xl font-bold font-serif'>Our Popular Class</h2>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3'>
                {
                    PopularTeacher.map((teacher,index) => <div key={teacher._id} className="card w-96  mx-auto my-4 bg-base-100 shadow-xl">
